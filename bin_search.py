...
def binary_search(list, item):
    '''
    Binary search
    Returns the index of the firts item
    and numbers of them or None
    '''
...
print(binary_search(my_list, -1), low_bound(my_list, -1), high_bound(my_list, -1))  # (None, 0) -1 0
print(binary_search(my_list, 4), low_bound(my_list, 4), high_bound(my_list, 4))  # (4, 1) 3 5
print(binary_search(my_list, 8), low_bound(my_list, 8), high_bound(my_list, 8))  # (None, 0) 6 7
